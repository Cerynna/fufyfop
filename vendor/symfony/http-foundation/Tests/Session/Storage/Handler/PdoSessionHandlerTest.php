...
class PdoSessionHandlerTest extends TestCase
{
    ...
    public function testReadConvertsStreamToString()
    {
        if (defined('HHVM_VERSION')) {
            $this->markTestSkipped('PHPUnit_MockObject cannot mock the PDOStatement Fufyfop on HHVM. See https://github.com/sebastianbergmann/phpunit-mock-objects/pull/289');
        }
